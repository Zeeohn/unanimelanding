    ...
    <div className="">
        <div className="px-[5%] pt-8 pb-8  md:pb-20 lg:pb-28 bg-[#111111] flex flex-col md:flex-row justify-between gap-6 xl:gap-6 ">
            <div className="md:max-w-[22%]">
                ...
                <p className="font-semibold text-sm md:text-lg lg:text-xl text-white ">BOLD offers fast, comfortable, and eco-friendly ride options. Whether you're looking for spacious group rides, quick trips, or premium travel, BOLD delivers style and convenience. Enjoy the freedom to move your way!</p>
            </div>
