    ...
    "
          ...
          <div className="bg-[url('/Assets/drivebackground.png')] bg-cover py-16 md:pt-24 md:pb-14 px-[5%] flex">
            <div className=" md:max-w-[50%]">
                <p className="font-bold text-4xl lg:text-[40px] lg:leading-[60px] font-redhat text-white">Lorem ipsum amet, consectetur adipiscing elit dolor</p>
                <div className="flex flex-wrap justify-between py-8 md:pt-4 md:pb-10">
                    <div className="flex gap-4 items-center pt-6">
                        <Image src={whitecheck} alt="whitecheck" className="w-4 sm:w-6"/>
                ...
                Become a partner
                <span className="inline-flex items-center"><Image src={btnrightarrow} alt="btnarrow " width={16}></Image></span>
              </button>
            </div>
          ...
          <div className="px-[5%] py-12 md:pt-16 md:pb-20 lg:pt-20 lg:pb-28">
            <p className="font-bold text-xl font-opensans md:text-3xl lg:text-4xl">How it works</p>
            <p className="text-sm md:text-xl pt-2 md:pt-4 lg:pt-8">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
            <div className="mt-4 md:mt-8 lg:mt-14 xl:mt-20 flex flex-col md:flex-row gap-4 justify-between md:gap-[4%]">
              <div className="px-4 py-8 md:p-8 bg-[#FFFFFF] rounded-2xl space-y-3 md:space-y-5 lg:space-y-0" style={{boxShadow:"4px 4px 35px 0px #0000000D"}}>
                <Image src={highearning} alt="assist" className="md:h-20 md:w-20 h-12 w-12"/>
                <p className="lg:pt-12 font-bold text-xl md:text-3xl">Higher earnings</p>
              ...
              <div className="px-4 py-8 md:p-8 bg-[#FFFFFF] rounded-2xl space-y-3 md:space-y-5 lg:space-y-0" style={{boxShadow:"4px 4px 35px 0px #0000000D"}}>
                <Image src={flexiblework} alt="assist" className="md:h-20 md:w-20 h-12 w-12 " />
                <p className="lg:pt-12 font-bold text-xl md:text-3xl">Flexible work</p>
                <p className="text-[#777777]  text-smmd:text-xl lg:pt-8">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                  eiusmod tempor incididunt ut labore et dolore magna
                </p>
              ...
              <div className="px-4 py-8 md:p-8 bg-[#FFFFFF] rounded-2xl space-y-3 md:space-y-5 lg:space-y-0" style={{boxShadow:"4px 4px 35px 0px #0000000D"}}>
                <Image src={smoothpayout} alt="assist" className="md:h-20 md:w-20 h-12 w-12 " />
                <p className="lg:pt-12 font-bold text-xl md:text-3xl">Smooth payouts</p>
                <p className="text-[#777777]  text-smmd:text-xl lg:pt-8">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                  eiusmod tempor incididunt ut labore et dolore magna
                </p>
          ...
          <div className="px-[5%] ">
            <p className="font-bold text-xl font-opensans md:text-3xl lg:text-4xl">What do you need to become a BOLD partner?</p>
            <div className="flex md:flex-row flex-col gap-6 justify-between mt-6 md:mt-8 lg:mt-10 pb-12 md:pb-20 lg:pb-28 md:gap-6 lg:gap-8">
                <div className="">
                    ...
                    <p className="font-semibold text-base md:text-xl lg:text-2xl pt-[14px] md:pt-6 lg:pt-8">Basic requirements</p>
                    <p className="text-sm md:text-base pt-2">. Lorem Ipsum is not simply random text.</p>
                    <p className="text-sm md:text-base pt-2">. Lorem Ipsum is not simply random text.</p>
                </div>
                <div className="">
                    <Image src={documents} alt="blackstr" className="w-7 md:w-12"/>
                    <p className="font-semibold text-base md:text-xl lg:text-2xl pt-[14px] md:pt-6 lg:pt-8">Documents</p>
                    <p className="text-sm md:text-base pt-2">. Lorem Ipsum is not simply random text.</p>
                    <p className="text-sm md:text-base pt-2">. Lorem Ipsum is not simply random text.</p>
                </div>
                <div className="">
                    <Image src={blacktick} alt="blackstr" className="w-7 md:w-12"/>
                    <p className="font-semibold text-base md:text-xl lg:text-2xl pt-[14px] md:pt-6 lg:pt-8">Sign up process</p>
                    <p className="text-sm md:text-base pt-2">. Lorem Ipsum is not simply random text.</p>
                    <p className="text-sm md:text-base pt-2">. Lorem Ipsum is not simply random text.</p>
                </div>
            </div>
          ...
          <div className="flex justify-between px-[5%] items-center py-12 md:py-20 lg:py-28 ">
            <div className="md:max-w-[50%] lg:max-w-[50%] flex flex-col justify-center">
                <p className="font-bold text-xl font-opensans md:text-3xl lg:text-4xl">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor</p>
                <p className="font-semibold text-sm md:text-xl pt-2 sm:pt-4 md:pt-6 lg:pt-8 max-w-[80%]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut ad minim veniam, quis.</p>
                <div className="flex gap-2">
                    <div>
                    <button className="p-4 text-white bg-black font-redhat font-semibold text-sm md:text-xl flex items-center gap-2 rounded-lg mt-6 md:mt-8 lg:mt-12">Become a partner <span className="inline-flex items-center text-white"><Image src={whitearrow} alt="btnarrow " width={16}></Image></span></button>
                    </div>
                    <Image src={curlyarrow} alt="curlyarrow" className="max-h-[48px] md:max-h-full"/>
                </div>
            </div>
            <Image src={driverappsingle} alt="driverapp" className="md:w-[50%] lg:w-[35%] md:block hidden"/>
          </div>
