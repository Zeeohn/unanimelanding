    ...
    <div className="">
      <div className="px-[5%] py-20">
        ...
        <p className="pt-4 font-opensans text-xl text-[#444444] max-w-[60%]">
          Got a question or need help with your ride? We’re here for you!
          Whether it’s about booking, trip details, or anything in between, our
          support resources are designed to make your experience as smooth as
          possible. Let’s make every ride a smooth one!
        </p>
        <div className="bg-[#EEEEEE] flex px-4 py-6 gap-4 rounded-2xl w-4/5 mt-16">
          ...
          <input
            ...
            className="bg-[#EEEEEE] w-full outline-none"
          />
        </div>
        ...
        <div className="pt-20 pb-5 flex border-b border-[#DDDDDD]">
          ...
          <div className="flex-1">
            <div
              ...
              onClick={() => setcurrentsupport("detailsupport")}
            >
          ...
          <div className="flex rounded-3xl justify-between pl-[5%] items-center  bg-[#191919] ">
            <div className="max-w-[55%] flex flex-col justify-center">
              ...
              <p className="font-semibold text-xl pt-8  text-white">
                Your ride, your way—safe, easy, and reliable. Available on IOS
                and Android app stores.
              </p>
              <div className="flex gap-2 ">
                <div>
                  <button className="px-6 py-3 bg-[#18C4B8] hover:bg-[#12a096]  font-redhat text-white font-semibold text-xl flex items-center gap-2 rounded-lg mt-12">
                    Get the BOLD app
