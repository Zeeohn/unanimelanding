  ...
  return (
    <div className="">
      <div className="relative">
        ...
        <Image src={drivesafe} alt="logistic" className="h-[60vh] md:h-[100vh]" />
      ...
      <div className="flex flex-col gap-12 md:flex-row justify-between md:mt-10 md:pb-20 px-[5%]">
        <div className="">
          ...
          <p className="font-semibold text-lg md:text-2xl pt-8">In-App Safety Features</p>
        ...
        <div className="">
          ...
          <p className="font-semibold text-lg md:text-2xl pt-8">A Community Built on Inclusivity</p>
          <p className=" text-sm md:text-base pt-2">
        ...
        <div className="">
          ...
          <p className="font-semibold text-lg md:text-2xl pt-8">Round-the-Clock Support</p>
          <p className=" text-sm md:text-base pt-2">
      ...
      <h2 className="font-bold text-xl md:mt-0 mt-10 px-[5%] md:text-4xl" >Safety Tips</h2>
      <div className="flex flex-col gap-12 md:flex-row justify-between mt-10 md:pb-20 px-[5%]">
        <div className="">
          <Image src={blackstr} alt="blackstr" width={48} />
          <p className="font-semibold text-lg md:text-2xl pt-8">Confirm the driver</p>
          <p className=" text-sm md:text-base pt-2">
        ...
        <div className="">
          <Image src={documents} alt="blackstr" width={48} />
          <p className="font-semibold text-lg md:text-2xl pt-8">Check the vehicle make and model</p>
          <p className=" text-sm md:text-base pt-2">
          Make sure the colour and model of the vehicle match with what’s in the app
          </p>          
        </div>
        <div className="">
          <Image src={blacktick} alt="blackstr" width={48} />
          <p className="font-semibold text-lg md:text-2xl pt-8">Confirm the license plate</p>
          <p className=" text-sm md:text-base pt-2">
      ...
      <div className="flex flex-col md:flex-row justify-between px-[5%] items-center py-12 md:py-28 ">
        ...
        <div className="md:max-w-[50%] flex flex-col justify-center ">
          ...
          Whether you’re commuting to work, traveling o another city or just going to hang out, Bold gives you luxury. 
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col-reverse md:flex-row justify-between px-[5%] gap-8 items-center pb-28 ">
        <div className="md:max-w-[50%] flex flex-col justify-center ">
          ...
          <p className="text-base md:text-xl font-semibold pt-8 font-opensans">
          Big trips need big solutions. There’s room for everyone and everything with BoldXL. These spacious rides make family trips a breeze.
          </p>
        </div>
        <Image
      ...
      <div className="px-[5%] pb-28 ">
        <div className="flex flex-row rounded-3xl justify-between pl-[5%] items-center  bg-[#191919] ">
          <div className="md:max-w-[55%] flex flex-col justify-center">
            ...
            <p className="md:font-semibold text-sm md:text-xl md:pt-8 pt-2 max-w-[70%] md:max-w-[80%] text-white"> There’s more to <span className="font-bold">BOLD</span>. Bold is not just about getting you from point A to point B. We offer a variety of services designed to enhance your daily life and solve real-world problems.
            </p>
